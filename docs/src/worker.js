...
importScripts(location.origin + "/hmc-container2wasm" + "/src/browser_wasi_shim/index.js");
importScripts(location.origin + "/hmc-container2wasm" + "/src/browser_wasi_shim/wasi_defs.js");
importScripts(location.origin + "/hmc-container2wasm" + "/src/worker-util.js");
importScripts(location.origin + "/hmc-container2wasm" + "/src/wasi-util.js");
